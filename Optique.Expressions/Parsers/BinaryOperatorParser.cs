...
namespace Optique.Expressions
{
    ...
    {
        private static readonly Dictionary<string, Func<IValueGetter, IValueGetter, dynamic>>
            Operations = new Dictionary<string, Func<IValueGetter, IValueGetter, dynamic>>
            {
                ...
                // {Operators.Assignment, (left, right) =>
                // {
                //     if (left is IValueSetter setter)
                //     {
                //         dynamic result = right.GetValue();
                //         setter.SetValue(result);
                //         return result;
                //     }
                //     else
                //     {
                //         throw new Exception("Left operand is not implements IValueSetter");
                //     }
                // }}
            };
        ...
        {
            if (Operations.ContainsKey(unparsedValue))
            {
